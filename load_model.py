# python load_model.py --label-name 'cls_prob' --img 'frame-1.jpg' --prefix 'model/deploy_model_algo_1'
import mxnet as mx
import numpy as np
# import picamera
...
class ImagenetModel(object):
    ...
    """
    def __init__(self, synset_path, network_prefix, params_url=None, symbol_url=None, synset_url=None, context=mx.cpu(), label_names=['prob_label'], input_shapes=[('data', (1,3,300,300))]):
    ...
    """
    def predict_from_file(self, filename, reshape=(300, 300), N=5):
